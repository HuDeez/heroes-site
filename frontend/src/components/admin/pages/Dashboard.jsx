            ...
            <div
                ...
                <div className="card-body bg-[#E9EBF6] w-[500px] p-3 rounded-2xl flex flex-col gap-4">
                    <div className="head p-2 bg-[#D6D4F6] rounded-3xl w-full">
                        <h1 className="text-black text-center">Добавление нового профиля</h1>
                    </div>
        ...
        <div className="w-full h-full content-center p-8">
            <div className="content-wrapper flex flex-col justify-between bg-[#FAFAFA] h-full rounded-2xl">
                <div className="admins-list p-6 text-center content-center">
                    ...
                    <div className="admins grid grid-cols-4 gap-4 p-4">
                        {admins.map((admin) => (
                            <AdminCard
                                dates={admin}
                                key={admin.username}
                ...
                <div className="footer w-full p-4">
                    <div
                        ...
                        <div className="body flex flex-row justify-between w-full">
                            <div className="quantity p-2 bg-[#D6D4F6] rounded-2xl">
                            ...
                            {
                                user?.access >= 1 && <div className="buttons p-2">
                                    <button
                                        className="p-3 bg-[#D6D4F6] hover:bg-[#B9B6FF] cursor-pointer transition-all text-black rounded-2xl w-full"
                                        onClick={open}
                                    >
